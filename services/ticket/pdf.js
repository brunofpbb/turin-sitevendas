// services/ticket/pdf.js — rev5
// - Logo ao lado esquerdo do bloco da empresa
// - Bloco "Detalhes da viagem" (aprovado)
// - Linha "Passageiro / Documento" com separadores
// - Totais em 2 colunas (esq: tarifa/taxa/outros | dir: forma/valor pago)
// - Bloco do QR: ordem e centralização solicitadas
// - 1 página, sem rodapé
...
exports.generateTicketPdf = async (t, outDir) => {
  ...
  // ===== BLOCO DO QR (ordem nova — tudo centralizado)
  doc.moveDown(0.3);
